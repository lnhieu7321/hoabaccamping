...
!(function (t) {
        ...
        l(e),
            e.each(function (n, i) {
                var l = n === e.length - 1 ? s : r,
                    c = t(i).outerHeight(!0);
                c < l
                    ? (o.push(i), a.push(c), u.push(t(i).height()))
                    : (h += c);
            }),
            i &&
                ((n -= h),
    ...
    function L(t, e, n) {
        return n.func
            ? n.func(t, e)
            : N(t[n.field], e[n.field]) * (n.order || 1);
    }
    function N(e, n) {
        return e || n
            ? null == n
    ...
    function W(t, e) {
        ...
        return tt(t) || tt(e)
            ...
            : ((n = t.asMonths()),
              (i = e.asMonths()),
              Math.abs(n) >= 1 && vt(n) && Math.abs(i) >= 1 && vt(i)
                  ? n / i
                  : t.asDays() / e.asDays());
    }
    function Y(t, n) {
    ...
    function U(t, e) {
        return (
            (t = q(t)),
            e.start && (t.start = j(t.start, e)),
            e.end && (t.end = K(t.end, e.end)),
            t
        );
    }
    function j(t, e) {
        return (
            (t = t.clone()),
            e.start && (t = J(t, e.start)),
            e.end && t >= e.end && (t = e.end.clone().subtract(1)),
            t
        );
    }
    function Z(t, e) {
    ...
    function X(t, e) {
        return (
            ((t.start && e.start && t.start.isSame(e.start)) ||
                (!t.start && !e.start)) &&
            ((t.end && e.end && t.end.isSame(e.end)) || (!t.end && !e.end))
        );
    }
    function K(t, e) {
    ...
    function Et(t, e) {
        var n;
        return (
            ot(e, "constructor") && (n = e.constructor),
            "function" != typeof n &&
                (n = e.constructor =
                    function () {
                        t.apply(this, arguments);
                    }),
            (n.prototype = rt(t.prototype)),
            st(e, n.prototype),
            st(t, n),
            n
        );
    ...
    function Ht(t, e) {
        return (
            (!t && !e) ||
            (!(!t || !e) && t.component === e.component && Rt(t, e) && Rt(e, t))
        );
    }
    function Rt(t, e) {
        for (var n in t)
                            ...
                            "title" == i
                                ...
                                : ((r = o[i])
                                      ...
                                      ? ((h = function () {
                                        ...
                                        v.push(i),
                                        (c = u.buttonTextOverride),
                                        (d = u.buttonTextDefault))
                                      : e[i] &&
                                        ((h = function () {
                                            e[i]();
                                        }),
                                        (c = (e.overrides.buttonText || {})[i]),
                                        (d = a[i])),
                                  h &&
                                      ((f = r
                                          ? r.themeIcon
                                          : e.opt("themeButtonIcons")[i]),
                                      (g = r
                                          ? r.icon
                                          : e.opt("buttonIcons")[i]),
                                      (m = c
    ...
    function Ut() {
        ...
        function r(t) {
            ...
            for (e = 0; e < t.length; e++)
                (n = t[e]),
                    n.start.clone().stripZone() < j &&
                        q.getEventEnd(n).stripZone() > U &&
                        i.push(n);
            return i;
        }
        function s(t, e) {
                ...
                if (n === e._fetchId && "rejected" !== e._status) {
                    if (((e._status = "resolved"), i))
                        for (r = 0; r < i.length; r++)
                            (s = i[r]),
                                (o = a ? s : z(s, e)) && K.push.apply(K, _(o));
                    d();
                }
            });
        }
        ...
        function R(t) {
            ...
            for (e = 0; e < t.length; e++)
                (n = t[e]),
                    (n.start = q.moment(n.start)),
                    n.end ? (n.end = q.moment(n.end)) : (n.end = null),
                    W(n, x(n));
            i();
        }
        function x(e) {
        ...
        function B(e) {
            ...
            for (
                ...
                t.isArray(Q[r].events) &&
                    (Q[r].events = t.grep(Q[r].events, e, !0));
            i();
        }
        function L(e) {
        ...
        function N(t) {
            (t.start = q.moment(t.start)),
                t.end && (t.end = q.moment(t.end)),
                jt(t);
        }
        function z(n, i) {
            var r,
            ...
            if (
                ...
                t.extend(l, n),
                i && (l.source = i),
                (l._id = n._id || (void 0 === n.id ? "_fc" + Le++ : n.id + "")),
                n.className
                    ? "string" == typeof n.className
                ...
                s && ((s = q.moment(s)), s.isValid() || (s = null)),
                    (o = n.allDay),
                    void 0 === o &&
                        (o = ut(
        ...
        function O(t) {
            P(t),
                ...
                t.end ||
                    (q.opt("forceEventDuration")
                        ? (t.end = q.getDefaultEventEnd(t.allDay, t.start))
                        : (t.end = null));
        }
        function P(t) {
            null == t.allDay &&
                ...
                t.allDay
                    ...
                    : (t.start.hasTime() ||
                          (t.start = q.applyTimezone(t.start.time(0))),
                      t.end &&
                          !t.end.hasTime() &&
                          (t.end = q.applyTimezone(t.end.time(0))));
        }
        function _(e, n, i) {
            var r,
                s,
            ...
            return (
                ...
                (s = {
                    start: e._start.clone(),
                        ...
                        ? e._end.clone()
                        : q.getDefaultEventEnd(e._allDay, e._start),
                    allDay: n.allDay,
                }),
                O(s),
                ...
                (a = r(n.start, s.start)),
                n.end
                    ? ((l = r(n.end, s.end)), (u = l.subtract(a)))
                    : (u = null),
                t.each(n, function (t, e) {
                    I(t) && void 0 !== e && (c[t] = e);
                }),
                (h = Y(L(e._id), o, n.allDay, a, u, c)),
                { dateDelta: a, durationDelta: u, undo: h }
            );
        }
                ...
                t.each(e, function (e, u) {
                    ...
                    (h = {
                        ...
                        n
                            ...
                            : s &&
                              !c.end &&
                              (c.end = q.getDefaultEventEnd(c.allDay, c.start)),
        ...
        var q = this;
        (q.requestEvents = n),
            (q.reportEventChange = i),
            (q.isFetchNeeded = s),
            (q.fetchEvents = o),
            (q.fetchEventSources = u),
            (q.refetchEvents = a),
            (q.refetchEventSources = l),
            (q.getEventSources = w),
            (q.getEventSourceById = S),
            (q.addEventSource = g),
            (q.removeEventSource = v),
            (q.removeEventSources = m),
            (q.updateEvent = H),
            (q.updateEvents = R),
            (q.renderEvent = k),
            (q.renderEvents = M),
            ...
            (q.clientEvents = L),
            (q.mutateEvent = W),
            (q.normalizeEventDates = O),
            (q.normalizeEventTimes = P);
        var U,
            j,
            Z,
            $ = { events: [] },
            ...
            K = [];
        t.each(
            (q.opt("events") ? [q.opt("events")] : []).concat(
                q.opt("eventSources") || []
            ),
            function (t, e) {
                var n = p(e);
    ...
    (Zt.intersectRanges = z),
        ...
        (Zt.cssToStr = dt),
        (Zt.proxy = mt),
        (Zt.capitaliseFirstLetter = gt),
        (Zt.getOuterRect = d),
        (Zt.getClientRect = f),
        (Zt.getContentRect = g),
        (Zt.getScrollbarWidths = p);
    var Xt = null;
    (Zt.preventDefault = H),
        (Zt.intersectRects = R),
        (Zt.parseFieldSpecs = M),
        (Zt.compareByFieldSpecs = B),
        (Zt.compareByFieldSpec = L),
        (Zt.flexibleCompare = N),
        (Zt.computeGreatestUnit = V),
        (Zt.divideRangeByDuration = _),
        (Zt.divideDurationByDuration = W),
        (Zt.multiplyDuration = Y),
        (Zt.durationHasTime = tt);
    ...
    se.push("_fullCalendar"),
        ...
        (ie.week = ie.weeks =
            function (t) {
                ...
                return null == t && "function" == typeof e
                    ? e(this)
                    : "ISO" === e
                    ? re.isoWeek.apply(this, arguments)
                    : re.week.apply(this, arguments);
            }),
        (ie.time = function (t) {
        ...
        (ie.local = function (t) {
            return (
                re.local.call(this, this._ambigZone || t),
                (this._ambigTime = !1),
                (this._ambigZone = !1),
                this
            );
        ...
        (ie.utcOffset = function (t) {
            return (
                ...
                re.utcOffset.apply(this, arguments)
            );
        }),
        (ie.format = function () {
            return this._fullCalendar && arguments[0]
                ? oe(this, arguments[0])
                : this._ambigTime
                ? le(St(this), "YYYY-MM-DD")
                : this._ambigZone
                ? le(St(this), "YYYY-MM-DD[T]HH:mm:ss")
                : this._fullCalendar
                ? le(St(this))
                : re.format.apply(this, arguments);
        }),
        (ie.toISOString = function () {
            return this._ambigTime
                ...
                ? le(St(this), "YYYY-MM-DD[T]HH:mm:ss")
                : this._fullCalendar
                ? re.toISOString.apply(St(this), arguments)
                : re.toISOString.apply(this, arguments);
        }),
        (function () {
            function t(t, e) {
            ...
            function n(t, e, n, s, o) {
                var a;
                return (
                    (t = Zt.moment.parseZone(t)),
                    (e = Zt.moment.parseZone(e)),
                    (a = t.localeData()),
            ...
            (Zt.formatDate = t),
                (Zt.formatRange = n),
                (Zt.oldMomentFormat = e),
                (Zt.queryMostGranularFormatUnit = f);
            var g = "\v",
                p = "",
                v = "",
    ...
    var ue = bt.extend(fe, ge, {
        ...
        _watchDeps: function (t, e, n) {
            ...
            function r(t, n, i) {
                void 0 === n
                    ? (i || void 0 === h[t] || u--, delete h[t])
                    : (i || void 0 !== h[t] || u++, (h[t] = n)),
                    --a || (u === l && (d || e(h)));
            }
            function s(t, e) {
                o.on(t, e), c.push([t, e]);
    ...
    var ce = bt.extend(fe, {
        ...
        tryStart: function () {
            !this.isRunning &&
                this.canRunNext() &&
                ((this.isRunning = !0), this.trigger("start"), this.runNext());
        },
        canRunNext: function () {
    ...
    var fe = (Zt.EmitterMixin = {
        ...
        ve = (Zt.CoordCache = bt.extend({
            ...
            queryBoundingRect: function () {
                ...
                return this.els.length > 0 &&
                    ((t = c(this.els.eq(0))), !t.is(document))
                    ? f(t)
                    : null;
            },
        ...
        me = (Zt.DragListener = bt.extend(ge, {
            ...
            startInteraction: function (e, n) {
                ...
                this.isInteracting ||
                    ((n = n || {}),
                    (this.delay = ut(n.delay, this.options.delay, 0)),
                    (this.minDistance = ut(
                        n.distance,
            ...
            (this.isAutoScroll =
                ...
                this.isAutoScroll &&
                    this.listenTo(
                        t,
                        "scroll",
                        yt(this.handleDebouncedScroll, 100)
                    );
        },
    ...
    var ye = me.extend({
        ...
        handleInteractionStart: function (t) {
            ...
            this.component.hitsNeeded(),
                ...
                me.prototype.handleInteractionStart.apply(this, arguments);
        },
        handleDragStart: function (t) {
            var e;
            me.prototype.handleDragStart.apply(this, arguments),
                (e = this.queryHit(b(t), E(t))) && this.handleHitOver(e);
        },
        handleDrag: function (t, e, n) {
            var i;
            me.prototype.handleDrag.apply(this, arguments),
        ...
        handleDragEnd: function () {
            this.handleHitDone(),
                me.prototype.handleDragEnd.apply(this, arguments);
        },
        ...
        handleInteractionEnd: function () {
            me.prototype.handleInteractionEnd.apply(this, arguments),
                (this.origHit = null),
                (this.hit = null),
                this.component.hitsNotNeeded();
        },
        handleScrollEnd: function () {
            me.prototype.handleScrollEnd.apply(this, arguments),
                this.isDragging &&
    ...
    var Se = bt.extend(ge, {
        ...
        be = (Zt.Grid = bt.extend(ge, {
            ...
            dayMousedown: function (t) {
                var e = this.view;
                we.get().shouldIgnoreMouse() ||
                    (this.dayClickListener.startInteraction(t),
                    e.opt("selectable") &&
                        this.daySelectListener.startInteraction(t, {
            ...
            dayTouchStart: function (t) {
                ...
                n.isSelected ||
                    n.selectedEvent ||
                    ((e = n.opt("selectLongPressDelay")),
                    null == e && (e = n.opt("longPressDelay")),
                    this.dayClickListener.startInteraction(t),
                    n.opt("selectable") &&
                        this.daySelectListener.startInteraction(t, {
                            delay: e,
                ...
                var t,
                    ...
                    i = new ye(this, {
                        ...
                        interactionEnd: function (i, r) {
                            ...
                            !r &&
                                t &&
                                (s = e.getSafeHitSpan(t)) &&
                                n.triggerDayClick(s, e.getHitEl(t), i);
                        },
                    });
                return (
                    (i.shouldCancelTouchScroll = !1),
            ...
            buildDaySelectListener: function () {
                ...
                return new ye(this, {
                    ...
                    hitOver: function (n, i, r) {
                        var o, a;
                        r &&
                            ((o = e.getSafeHitSpan(r)),
                            (a = e.getSafeHitSpan(n)),
                            (t = o && a ? e.computeSelection(o, a) : null),
                            t ? e.renderSelection(t) : !1 === t && s());
                    },
                    hitOut: function () {
                ...
                if (n.length) {
                    ...
                    t(o).each(function (e, i) {
                        ...
                        s && (l = s.call(r, o, l)),
                            l &&
                                ((l = t(l)),
                                l.is(r.fillSegTag) && ((o.el = l), a.push(o)));
                    });
                }
                return a;
            },
            ...
            getDayClasses: function (t, e) {
                ...
                return (
                    Z(t, i.activeRange)
                        ? (r.push("fc-" + Kt[t.day()]),
                          1 == i.currentRangeAs("months") &&
                              t.month() != i.currentRange.start.month() &&
                              r.push("fc-other-month"),
                          (n = i.calendar.getNow()),
                          t.isSame(n, "day")
                              ? (r.push("fc-today"),
                                !0 !== e && r.push(i.highlightStateClass))
                              : t < n
                              ? r.push("fc-past")
                              : r.push("fc-future"))
    ...
    be.mixin({
        ...
        handleSegClick: function (t, e) {
            !1 ===
                this.view.publiclyTrigger("eventClick", t.el[0], t.event, e) &&
                e.preventDefault();
        },
        ...
        handleSegMousedown: function (t, e) {
            !this.startSegResize(t, e, { distance: 5 }) &&
        ...
        buildSegDragListener: function (t) {
            ...
            var h = (this.segDragListener = new ye(a, {
                ...
                dragStart: function (n) {
                    h.isTouch && !a.isEventSelected(u) && a.selectEvent(u),
                        (e = !0),
                ...
                hitOver: function (e, o, l) {
                    var c,
                        ...
                        g = !0;
                    t.hit && (l = t.hit),
                        (c = l.component.getSafeHitSpan(l)),
                        (d = e.component.getSafeHitSpan(e)),
                        c && d
                            ? ((i = r.computeEventDrop(c, d, u)),
                              (g = i && r.isEventLocationAllowed(i, u)))
                            : (g = !1),
                        g || ((i = null), s()),
                        i && (f = a.renderDrag(i, t))
                            ? (f.addClass("fc-dragging"),
                              h.isTouch || r.applyDragOpacity(f),
                              n.hide())
                            : n.show(),
                        o && (i = null);
                },
                ...
                interactionEnd: function (s) {
                    delete t.component,
                        n.stop(!i, function () {
                            e && (a.unrenderDrag(), r.segDragStop(t, s)),
                                i
                                    ? a.reportSegDrop(t, i, r.largeUnit, l, s)
                                    : a.showEvent(u);
                        }),
        ...
        listenToExternalDrag: function (t, e, n) {
            ...
            (r.externalDragListener = new ye(this, {
                ...
                hitOver: function (t) {
                    ...
                    n
                        ? ((i = r.computeExternalDrop(n, l)),
                          (e =
                              i &&
                              r.isExternalLocationAllowed(i, l.eventProps)))
                        : (e = !1),
                        e || ((i = null), s()),
                        i && r.renderDrag(i);
                },
                ...
                interactionEnd: function (e) {
                    i && a.reportExternalDrop(l, i, t, e, n),
        ...
        buildSegResizeListener: function (t, e) {
            ...
            return (this.segResizeListener = new ye(this, {
                ...
                hitOver: function (n, o, l) {
                    ...
                    d && f
                        ? ((i = e
                              ? r.computeEventStartResize(d, f, h)
                              : r.computeEventEndResize(d, f, h)),
                          (u = i && r.isEventLocationAllowed(i, h)))
                        : (u = !1),
                        u
                            ? i.start.isSame(h.start.clone().stripZone()) &&
                              i.end.isSame(c.clone().stripZone()) &&
                              (i = null)
                            : ((i = null), s()),
                        i && (a.hideEvent(h), r.renderEventResize(i, t));
                },
                hitOut: function () {
                ...
                interactionEnd: function (e) {
                    n && r.segResizeStop(t, e),
                        i
                            ? a.reportSegResize(t, i, r.largeUnit, u, e)
                            : a.showEvent(h),
        ...
        computeEventResize: function (t, e, n, i) {
            ...
            return (
                ...
                r.allDay &&
                    tt(a) &&
                    ((r.allDay = !1), o.normalizeEventTimes(r)),
                r[t].add(a),
        ...
        invertRanges: function (t) {
            ...
            for (t.sort(Lt), e = 0; e < t.length; e++)
                (n = t[e]),
                    n.start > a && o.push({ start: a, end: n.start }),
                    n.end > a && (a = n.end);
        ...
        compareEventSegs: function (t, e) {
            return (
                ...
                B(t.event, e.event, this.view.eventOrderSpecs)
            );
        },
    }),
        (Zt.pluckEventDateProps = xt),
        (Zt.isBgEvent = It),
        (Zt.dataAttrPrefix = "");
    var Ee = (Zt.DayTableMixin = {
        ...
        De = (Zt.DayGrid = be.extend(Ee, {
            ...
            renderNumberCellHtml: function (t) {
                ...
                return o || i.cellWeekNumbersVisible
                    ? ((e = this.getDayClasses(t)),
                      e.unshift("fc-day-top"),
                      i.cellWeekNumbersVisible &&
                          (n =
    ...
    De.mixin({
        ...
        unrenderEvents: function () {
            this.removeSegPopover(),
                be.prototype.unrenderEvents.apply(this, arguments);
        },
        getEventSegs: function () {
            return be.prototype.getEventSegs
                .call(this)
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                ...
                t.isStart &&
                    ...
                    (c = '<span class="fc-time">' + ht(n) + "</span>"),
                (i =
                    '<span class="fc-title">' +
                    (ht(s.title || "") || "&nbsp;") +
                    "</span>"),
                '<a class="' +
                    ...
                    (this.isRTL ? i + " " + c : c + " " + i) +
                    "</div>" +
                    (a ? '<div class="fc-resizer fc-start-resizer" />' : "") +
                ...
                for (; o < e; )
                    (h = (m[r - 1] || [])[o]),
                        h
                            ? h.attr(
                                  "rowspan",
                                  parseInt(h.attr("rowspan") || 1, 10) + 1
                              )
                            : ((h = t("<td/>")), a.append(h)),
                        (v[r][o] = h),
                        (m[r][o] = h),
            ...
            limitRow: function (e, n) {
                ...
                if (n && n < S.segLevels.length) {
                    for (
                        ...
                        for (
                            l = r[a], i(l.leftCol), c = [], h = 0;
                            E <= l.rightCol;

                        )
                            (u = this.getCellSegs(e, E, n)),
                                c.push(u),
                                (h += u.length),
                                E++;
                        if (h) {
    ...
    var Te = (Zt.TimeGrid = be.extend(Ee, {
        ...
        renderSlatRowHtml: function () {
            for (
                var t,
                    ...
                    s = this.isRTL,
                    o = "",
                    a = e.duration(+this.view.minTime);
                a < this.view.maxTime;

            )
                (t = this.start.clone().time(a)),
                    (n = vt(W(a, this.labelInterval))),
                    (i =
        ...
        sliceRangeByTimes: function (t) {
            ...
            for (n = 0; n < this.daysPerRow; n++)
                (i = this.dayDates[n].clone().time(0)),
                    (r = {
    ...
    Te.mixin({
        ...
        fgSegHtml: function (t, e) {
            ...
            return (
                h.unshift("fc-time-grid-event", "fc-v-event"),
                s.isMultiDayEvent(o)
                    ? (t.isStart || t.isEnd) &&
                ...
                '<a class="' +
                    ...
                    (n
                        ...
                        : "") +
                    (o.title
                        ? '<div class="fc-title">' + ht(o.title) + "</div>"
                        : "") +
                    '</div><div class="fc-bg"/>' +
        ...
        computeSegVerticals: function (t) {
            ...
            for (e = 0; e < t.length; e++)
                (n = t[e]),
                    ...
                    (n.top = this.computeDateTop(n.start, i)),
                    (n.bottom = this.computeDateTop(n.end, i));
        },
    ...
    var Ce = (Zt.View = ue.extend({
        ...
        constructor: function (t, n) {
            ue.prototype.constructor.call(this),
                (this.calendar = t),
                (this.viewSpec = n),
                (this.type = n.type),
        ...
        computeTitle: function () {
            var t;
            return (
                (t = /^(year|month)$/.test(this.currentRangeUnit)
                    ? this.currentRange
                    : this.activeRange),
                this.formatRange(
                    {
        ...
        computeTitleFormat: function () {
            return "year" == this.currentRangeUnit
                ? "YYYY"
                : "month" == this.currentRangeUnit
                ? this.opt("monthYearFormat")
                : this.currentRangeAs("days") > 1
                ? "ll"
                : "LL";
        },
        formatRange: function (t, e, n) {
            ...
            return (
                ...
                ae(t.start, i, e, n, this.opt("isRTL"))
            );
        },
        ...
        setDate: function (t) {
            ...
            return (
                (e && X(e.activeRange, n.activeRange)) ||
        ...
        queryScroll: function () {
            var e = {};
            return (
                this.isDatesRendered && t.extend(e, this.queryDateScroll()), e
            );
        },
        ...
        reportSegDrop: function (t, e, n, i, r) {
            ...
            this.triggerEventDrop(t.event, o.dateDelta, a, i, r),
                s.reportEventChange();
        },
        ...
        isEventResizableFromStart: function (t) {
            return (
                this.opt("eventResizableFromStart") && this.isEventResizable(t)
            );
        },
        ...
        reportSegResize: function (t, e, n, i, r) {
            ...
            this.triggerEventResize(t.event, o.durationDelta, a, i, r),
                s.reportEventChange();
        },
    ...
    Ce.watch(
        ...
        Ce.mixin({
            ...
            setDateProfileForRendering: function (t) {
                (this.currentRange = t.currentRange),
                    (this.currentRangeUnit = t.currentRangeUnit),
                    (this.renderRange = t.renderRange),
                    (this.activeRange = t.activeRange),
                    (this.validRange = t.validRange),
                    (this.dateIncrement = t.dateIncrement),
                    (this.minTime = t.minTime),
                    (this.maxTime = t.maxTime),
                    (this.start = t.activeRange.start),
                    (this.end = t.activeRange.end),
                    (this.intervalStart = t.currentRange.start),
            ...
            buildDateProfile: function (t, n, i) {
                ...
                return (
                    i && (t = j(t, l)),
                    (r = this.buildCurrentRangeInfo(t, n)),
                    (s = this.buildRenderRange(r.range, r.unit)),
                    (o = q(s)),
                    this.opt("showNonCurrentDates") || (o = U(o, r.range)),
                    (u = e.duration(this.opt("minTime"))),
                    (h = e.duration(this.opt("maxTime"))),
                    this.adjustActiveRange(o, u, h),
                    (o = U(o, l)),
                    (t = j(t, o)),
                    (a = $(r.range, l)),
                    {
                ...
                return (
                    this.viewSpec.duration
                        ...
                        : ((i = this.getFallbackDuration()),
                          (r = V(i)),
                          (s = this.buildRangeFromDuration(t, e, i, r))),
                    this.normalizeCurrentRange(s, r),
                    { duration: i, unit: r, range: s }
                );
            },
            ...
            normalizeCurrentRange: function (t, e) {
                /^(year|month|week|day)$/.test(e)
                    ? (t.start.stripTime(), t.end.stripTime())
                    : (t.start.hasTime() || t.start.time(0),
                      t.end.hasTime() || t.end.time(0));
            },
            adjustActiveRange: function (t, e, n) {
                var i = !1;
                this.usesMinMaxTime &&
                    (e < 0 && (t.start.time(0).add(e), (i = !0)),
                    n > 864e5 && (t.end.time(n - 864e5), (i = !0)),
                    i &&
                        (t.start.hasTime() || t.start.time(0),
                        t.end.hasTime() || t.end.time(0)));
            },
            ...
            buildCustomVisibleRange: function (t) {
                var e = this.getRangeOption(
                    "visibleRange",
                    this.calendar.moment(t)
                );
            ...
            initHiddenDays: function () {
                var e,
                    ...
                    r = 0;
                for (
                    !1 === this.opt("weekends") && n.push(0, 6), e = 0;
                    e < 7;
                    e++
                )
    ...
    Re.mixin({
        ...
        populateOptionsHash: function () {
            var t, e, i, r, s;
            (t = ut(this.dynamicOverrides.locale, this.overrides.locale)),
                (e = xe[t]),
                e || ((t = Re.defaults.locale), (e = xe[t] || {})),
                (i = ut(
                    ...
                    this.optionsModel.watch(
                        ...
                        function (e) {
                            ...
                            e.monthNames && (s._months = e.monthNames),
                                e.monthNamesShort &&
                                    (s._monthsShort = e.monthNamesShort),
                                e.dayNames && (s._weekdays = e.dayNames),
                                e.dayNamesShort &&
                                    (s._weekdaysShort = e.dayNamesShort),
                                null == r && "ISO" === i && (r = 1),
                                null != r &&
                                    ((n = rt(s._week)),
                                    (n.dow = r),
            ...
            buildViewSpecButtonText: function (t, e) {
                ...
                (t.buttonTextOverride =
                    ...
                    (t.buttonTextDefault =
                        ...
                        n(Re.defaults) ||
                        (t.duration
                            ? this.humanizeDuration(t.duration)
                            : null) ||
                        e);
            },
        }),
        Re.mixin({
            ...
            initialRender: function () {
                ...
                n.addClass("fc"),
                    ...
                    this.optionsModel.watch(
                        ...
                        ["?theme"],
                        function (t) {
                            n.toggleClass("ui-widget", t.theme),
                                n.toggleClass("fc-unthemed", !t.theme);
                        }
                    ),
                    this.optionsModel.watch(
                        "applyingDirClasses",
            ...
            renderView: function (e, n) {
                ...
                i && (this.freezeContentHeight(), this.clearView()),
                    !this.view &&
                        e &&
                        ((this.view =
                            this.viewsByType[e] ||
                        ...
                        this.view.setElement(
                            t(
                                "<div class='fc-view fc-" + e + "-view' />"
                            ).appendTo(this.contentEl)
                        ),
                        this.toolbarsManager.proxyCall("activateButton", e)),
                    this.view &&
                        (n && this.view.addForcedScroll(n),
                        this.elementVisible() &&
                            (this.currentDate = this.view.setDate(
                                this.currentDate
                            ))),
        ...
        Re.mixin({
            ...
            initToolbars: function () {
                (this.header = new Wt(this, this.computeHeaderOptions())),
                    (this.footer = new Wt(this, this.computeFooterOptions())),
                    (this.toolbarsManager = new _t([this.header, this.footer]));
            },
        ...
        (Re.englishDefaults = { dayPopoverFormat: "dddd, MMMM D" }),
        (Re.rtlDefaults = {
    ...
    Zt.locale("en", Re.englishDefaults),
        (Zt.sourceNormalizers = []),
        (Zt.sourceFetchers = []);
        ...
        (Re.prototype.isSpanAllowed = function (t, e, n, i) {
            ...
            for (o = this.getPeerEvents(t, i), a = 0; a < o.length; a++)
                if (((l = o[a]), this.eventIntersectsRange(l, t))) {
                    ...
                    if (i) {
                        if (
                            !1 === (u = ut(l.overlap, (l.source || {}).overlap))
                        )
                            return !1;
    ...
    var ze = (Zt.BasicView = Ce.extend({
            ...
            buildRenderRange: function (t, e) {
                ...
                return (
                    /^(year|month)$/.test(e) &&
                        ...
                        n.end.weekday() &&
                            n.end.add(1, "week").startOf("week")),
                    this.trimHiddenDays(n)
                );
            },
            renderDates: function () {
        ...
        Ae = (Zt.MonthView = ze.extend({
            buildRenderRange: function () {
                var t,
                    e = ze.prototype.buildRenderRange.apply(this, arguments);
                return (
                    this.isFixedWeeks() &&
                        ((t = Math.ceil(e.end.diff(e.start, "weeks", !0))),
                        e.end.add(6 - t, "weeks")),
                    e
                );
            },
    ...
    ($t.basic = { class: ze }),
        ($t.basicDay = { type: "basic", duration: { days: 1 } }),
        ($t.basicWeek = { type: "basic", duration: { weeks: 1 } }),
        ($t.month = {
            class: Ae,
            duration: { months: 1 },
    ...
    var Ge = (Zt.AgendaView = Ce.extend({
            ...
            renderDates: function () {
                this.timeGrid.setRange(this.renderRange),
                    this.dayGrid && this.dayGrid.setRange(this.renderRange),
                    this.el
            ...
            updateSize: function (t) {
                this.timeGrid.updateSize(t),
                    Ce.prototype.updateSize.call(this, t);
            },
            updateWidth: function () {
            ...
            hitsNeeded: function () {
                this.timeGrid.hitsNeeded(),
                    this.dayGrid && this.dayGrid.hitsNeeded();
            },
            hitsNotNeeded: function () {
                this.timeGrid.hitsNotNeeded(),
                    this.dayGrid && this.dayGrid.hitsNotNeeded();
            },
            prepareHits: function () {
    ...
    ($t.agenda = {
        ...
        ($t.agendaDay = { type: "agenda", duration: { days: 1 } }),
        ($t.agendaWeek = { type: "agenda", duration: { weeks: 1 } });
    var We = Ce.extend({
            grid: null,
            scroller: null,
            initialize: function () {
                (this.grid = new Ye(this)),
                    (this.scroller = new He({
                        overflowX: "hidden",
                        overflowY: "auto",
                    }));
        ...
        Ye = be.extend({
            ...
            spanToSegs: function (t) {
                for (
                    var e,
                        n = this.view,
                        i = n.renderRange.start.clone().time(0),
                        r = 0,
                        s = [];
                    i < n.renderRange.end;
                    ...
                    if (
                        ((e = z(t, { start: i, end: i.clone().add(1, "day") })),
            ...
            handleSegClick: function (e, n) {
                var i;
                be.prototype.handleSegClick.apply(this, arguments),
            ...
            fgSegHtml: function (t) {
                ...
                return (
                    (e = s.allDay
                        ...
                        : n.isMultiDayEvent(s)
                        ? t.isStart || t.isEnd
                            ? ht(this.getEventTimeText(t))
                            : n.getAllDayHtml()
                        : ht(this.getEventTimeText(s))),
                    o && i.push("fc-has-url"),
                    '<tr class="' +
                        i.join(" ") +
                        '">' +
