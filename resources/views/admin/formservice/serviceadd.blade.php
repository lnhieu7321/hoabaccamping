...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <form action="{{ route('adminservice/save') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="row formtype">
                        ...
                        <div class="col-md-11">
                            <div class="form-group">
                                <label>Mô tả</label>
                                <div>
                                    <textarea type="text" class="form-control @error('description') is-invalid @enderror" name="description" id="description" value="{{ old('description') }}"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-11">
                        ...
                        <div class="col-md-11">
                            <div class="form-group">
                                <label for="business_id" class="mr-2">Doanh nghiệp: </label>

                                <select name="business_id" label="Doanh nghiệp" style="width: 300px;">
