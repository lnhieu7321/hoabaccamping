...
<div class="page-wrapper">
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <div class="mt-5">
                        <h4 class="card-title float-left mt-4">Quản lý dịch vụ</h4>
                        <div class="top-nav-search float-left">
                            <form method="get" action="{{route('adminsearch.service')}}">
                                <input type="search" name="query" placeholder="Tìm kiếm..." class="form-control">
                                <button class="btn" type="submit"><i class="fas fa-search"></i></button>
                            </form>
                        </div>
                        <a href="{{ route('form/adserviceadd') }}" class="btn btn-primary float-right veiwbutton ">Thêm</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body booking_card">
                        ...
                        <div class="table-responsive">
                            <table class="datatable table table-stripped table table-hover table-center mb-0 table-filter b-t b-light" id="myTable">
                                ...
                                <tbody>
                                    @foreach ($alladService as $services )
                                    <tr>
                                        <td>{{ $services->id }}</td>
                                        <td>{{ $services->businesses->business_name }}</td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('form/adserviceedit', $services->id) }}">
    ...
    <div class="modal fade" id="delete_asset">
        <div class="modal-dialog">
            <form action="{{ route('adminservice/delete', $services->id) }}" method="POST">
                @csrf
                @method('DELETE')
